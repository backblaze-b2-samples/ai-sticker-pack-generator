...
app = FastAPI(
    title="AI Sticker Pack Generator API",
    description=(
        "Generate themed sticker packs with a consistent visual style, "
        "store every artifact in Backblaze B2, and export per-platform "
        "bundles — no database, B2 is the sole store."
    ),
    version="0.1.0",
    lifespan=lifespan,
)
